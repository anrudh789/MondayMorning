            ...
            <div class="box-body">
              ...
              <table class="table table-bordered">
                ...
                <tr>
                  ...
                  <td>
                     <button type="button" data-toggle="modal" data-target="#myModal" class="btn btn-block btn-primary btn-sm">Edit</button></td>
     <div class="container">
  <!-- Modal -->
          ...
          <!-- /.box -->
                ...
                <tr>
                 ...
                 <!-- <td> <div class="progress progress-xs">
                   ...
                   <td>
                     <button type="button" data-toggle="modal" data-target="#myModaleducation" class="btn btn-block btn-primary btn-sm">Edit</button></td>
     <div class="container">
  <!-- Modal -->
        ...
        <!-- form END -->
          <!-- /.box -->
                ...
                <tr>
                 ...
                 <td>
                     <button type="button" data-toggle="modal" data-target="#myModalexperience" class="btn btn-block btn-primary btn-sm">Edit</button></td>
     <div class="container">
  <!-- Modal -->
            ...
            <div class="box-body">
              <table class="table table-bordered">
                <tr>
                  <td>1.</td>
                  <td>Assignment 1</td>
                  <td><button type="button" class="btn btn-block btn-primary btn-sm">View</button></td>
                </tr>
                <tr>
                  <td>2.</td>
                  <td>Assignment 2</td>
              ...
              <table class="table table-bordered">
               <tr>
                  ...
                  <td><span class="badge bg-red">55%</span></td>
                   <td>
                     <button type="button" data-toggle="modal" data-target="#myModalprofile" class="btn btn-block btn-primary btn-sm">Apply Now</button></td>
<div class="container">
  <!-- Modal -->
          ...
          <!-- /.box -->
                ...
                <tr>
                  ...
                  <td><span class="badge bg-yellow">70%</span></td>
                    ...
                    <td>
                     <button type="button" data-toggle="modal" data-target="#myModaledu" class="btn btn-block btn-primary btn-sm">Apply Now</button></td>
     <div class="container">
  <!-- Modal -->
        ...
        <!-- form END -->
          <!-- /.box -->
                ...
                <tr>
                  ...
                  <td>
                     <button type="button" data-toggle="modal" data-target="#myModalwork" class="btn btn-block btn-primary btn-sm">Apply Now</button></td>
     <div class="container">
  <!-- Modal -->
        ...
        <!-- form END -->
          ...
          <!-- /.box -->
                 ...
                 <td>References</td>
                  ...
                  <td><span class="badge bg-light-blue">30%</span></td>
                   <td>
                     <button type="button" data-toggle="modal" data-target="#myModalreferences" class="btn btn-block btn-primary btn-sm">Apply Now</button></td>
              ...
              <!-- /.box-body -->
               <tr>
                 <td>Family Background</td>
                  ...
                  <td><span class="badge bg-light-blue">30%</span></td>
                   <td>
                     <button type="button" data-toggle="modal" data-target="#myModalfamily" class="btn btn-block btn-primary btn-sm">Apply Now</button></td>
