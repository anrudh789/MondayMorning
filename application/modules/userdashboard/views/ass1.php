                ...
                <tr >
                  ...
                  <td style=" border-bottom-color: #112B4E;border-bottom: #112B4E;border: 1px solid #000;">
                     <div class="btn-group-vertical">
                       <a id="myBtn" href="<?php echo base_url()?>ass-2" class="btn btn-warning" style="background-color: #112B4E;
    border-color: #112b4e;">Start</a></td>
      ...
      <div class="modal-header" >
       ...
       <div class="modal-body" style="padding: 13px 27px 51px 22px;">
				 ...
				 <button type="button" class="btn btn-danger red pull-right" data-dismiss="modal" style="margin-left: 5px">Deny</button>
				  <button type="button" style="background-color: #112b4e" class="btn btn-success  pull-right" data-dismiss="modal" >Accept</button>
      </div>
